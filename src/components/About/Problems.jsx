...
export default function Problems() {
    return (
        <>
            <main className='mx-6  p-4 pb-0 rounded-xl mt-4'>
                ...
                <section className='m-8 grid  md:flex justify-around align-middle '>
                ...
                <section className='m-8  grid  md:flex  justify-around align-middle '>
                    ...
                    <div className='m-3 border-[3px] p-4 pb-0 shadow-2xl border-black  rounded-xl sm:w-[400px]  w-[300px] '>
