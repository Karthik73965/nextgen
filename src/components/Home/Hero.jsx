    ...
    <center>
     ...
     <span>
      ...
      {/* <TypeAnimation
        ...
        repeat={Infinity}
      /> */}
      <p className='my-8 sm:text-xl md:w-[700px] font-semibold bg-gray-200 p-3 border-2 border-gray-300 shadow-lg rounded-full text:sm text-black'>Any question. Any subject. Get instant, step-by-step solutions </p>
      <Link to="/login">
