...
export default function TermsConditions() {
  ...
  <h1 style={{ fontSize: 19 }}>TERMS AND CONDITIONS</h1>
</div>

                <div  className="  MsoNormal" style="line-height: 1.5;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  subtitle" style="line-height: 1.5;"><strong>Last
                                updated</strong>
                        <bdt  className="  question"><strong>March 24, 2024</strong></bdt>
                </div>
                <div  className="  MsoNormal" style="line-height: 1.1;"><br/></div>
                <div  className="  MsoNormal" style="line-height: 115%;"><br/></div>
                <div  className="  MsoNormal" style="line-height: 115%;"><br/></div>
                <div style="line-height: 1.5;"><strong><span data-custom- className="  heading_1">AGREEMENT TO OUR LEGAL
                                        TERMS</span></strong></div>
        </div>
        <div align="center" style="text-align: left;">
                <div  className="  MsoNormal" id="agreement" style="line-height: 1.5;"><a name="_6aa3gkhykvst"></a></div>
        </div>
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;">We are <bdt
                                        ...
                                        data-id="9d459c4e-c548-e5cb-7729-a118548965d2" data-type="question">dasTEK
                                        Solutions, LLC</bdt>
                                ...
                                "<strong>our</strong>"<bdt  className="  statement-end-if-in-editor"></bdt>)<span style="font-size:11.0pt;line-height:115%;
  ...
  mso-themetint:166;">
        ...
        <div align="center" style="text-align: left;">
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span style="font-size:11.0pt;line-height:115%;font-family:Arial;
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;">We operate <bdt  className="  block-component"></bdt>the
                                website <span style="color: rgb(0, 58, 250);">
                                        <bdt  className="  question"><a href="https://nexgenstudy.ai" target="_blank"
                                                        data-custom- className="  link">https://nexgenstudy.ai</a></bdt>
                                </span> (the <bdt  className="  block-component"></bdt>"<strong>Site</strong>"<bdt
                                         className="  statement-end-if-in-editor"></bdt>)<bdt  className="  block-component"></bdt>
                                <bdt  className="  block-component"></bdt>, as well as any other related products and services
                                that refer or link to these legal terms (the <bdt  className="  block-component"></bdt>
                                "<strong>Legal Terms</strong>"<bdt  className="  statement-end-if-in-editor"></bdt>)
                                (collectively, the <bdt  className="  block-component"></bdt>"<strong>Services</strong>"<bdt
                                         className="  statement-end-if-in-editor"></bdt>).<bdt  className="  block-component"></bdt>
                        </span></div>
                <div  className="  MsoNormal" style="line-height: 1;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span style="font-size:11.0pt;line-height:115%;font-family:Arial;
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;">You can contact us by <bdt  className="  block-component"</bdt>
                                        email at <bdt  className="  question">support@nexgenstudy.ai</bdt>
                                        <bdt  className="  block-component"></bdt> or by mail to <bdt  className="  question"></bdt>
                                        <bdt  className="  block-component"></bdt>, <bdt  className="  question"></bdt>
                                        <bdt  className="  block-component"></bdt>
                                        <bdt  className="  block-component"></bdt>, <bdt  className="  question">TX</bdt>
                                        ...
                                        <bdt  className="  statement-end-if-in-editor"></bdt>
                                        <bdt  className="  block-component"></bdt>.</span></div>
                <div  className="  MsoNormal" style="line-height: 1;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span style="font-size:11.0pt;line-height:115%;font-family:Arial;
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;">These Legal Terms constitute a legally binding
                                agreement made between you, whether personally or on behalf of an entity (<bdt
                                         className="  block-component"></bdt>"<strong>you</strong>"<bdt
                                         className="  statement-end-if-in-editor"></bdt>), and <bdt  className="  question">dasTEK
                                        Solutions, LLC</bdt>, concerning your access to and use of the Services. You
                                ...
                                IMMEDIATELY.<bdt  className="  block-component"></bdt></span></div>
                <div  className="  MsoNormal" style="line-height: 1;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span style="font-size:11.0pt;line-height:115%;font-family:Arial;
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;">Supplemental terms and conditions or documents that
                                may be posted on the Services from time to time are hereby expressly incorporated herein
                                by reference. We reserve the right, in our sole discretion, to make changes or
                                modifications to these Legal Terms <bdt  className="  block-component"></bdt>from time to time
                                <bdt  className="  else-block"></bdt>. We will alert you about any changes by updating the <bdt
                                         className="  block-component"></bdt>"Last updated"<bdt
                                         className="  statement-end-if-in-editor"></bdt> date of these Legal Terms, and you
                                ...
                                date such revised Legal Terms are posted.<bdt  className="  else-block"></bdt></span></div>
        </div>
        <div align="center" style="line-height: 1;"><br/></div>
        <div align="center" style="text-align: left;">
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;">
                ...
                <div  className="  MsoNormal" style="line-height: 1;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;">We recommend that you
                        print a copy of these Legal Terms for your records.</div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><br/></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  heading_1" style="line-height: 1.5;"><strong>TABLE OF
                                CONTENTS</strong></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><br/></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a href="#services"><span
                                        data-custom- className="  link"><span
                                                style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                        data-custom- className="  body_text">1. OUR
                                                        SERVICES</span></span></span></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#ip"><span
                                        style="color: rgb(0, 58, 250);"><span data-custom- className="  body_text">2.
                                                INTELLECTUAL PROPERTY RIGHTS</span></span></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#userreps"></a><a
                                data-custom- className="  link" href="#userreps"><span
                                        style="color: rbg(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">3. USER REPRESENTATIONS</span></span></a>
                </div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><span style="font-size: 15px;"><span
                                        data-custom- className="  body_text">
                                        <bdt  className="  block-component"></bdt>
                                </span></span><a data-custom- className="  link" href="#userreg"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">4. USER
                                                REGISTRATION</span></span></a><span style="font-size: 15px;"><span
                                        data-custom- className="  body_text">
                                        <bdt  className="  statement-end-if-in-editor"></bdt>
                                </span></span> <a data-custom- className="  link" href="#products"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#products"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">
                                                <bdt  className="  block-component"></bdt>
                                        </span></span></a> <a data-custom- className="  link" href="#purchases"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#purchases"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">
                                                <bdt  className="  block-component"></bdt>5. PURCHASES AND PAYMENT<bdt
                                                         className="  statement-end-if-in-editor"></bdt>
                                        </span></span></a>
                        <bdt  className="  block-component"><span style="font-size: 15px;"></bdt><br/></span>
                </div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><span style="font-size: 15px;"><span
                                        data-custom- className="  body_text">
                                        <bdt  className="  block-component"></bdt>
                                </span></span> <a data-custom- className="  link" href="#software"></a> <a
                                data-custom- className="  link" href="#software"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#software"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">
                                                <bdt  className="  block-component"></bdt>
                                        </span></span></a> <a data-custom- className="  link" href="#prohibited"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#prohibited"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">6. PROHIBITED ACTIVITIES</span></span></a>
                        <a data-custom- className="  link" href="#ugc"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#ugc"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">7. USER GENERATED
                                                CONTRIBUTIONS</span></span></a> <a data-custom- className="  link"
                                href="#license"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#license"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">8. CONTRIBUTION <bdt
                                                         className="  block-component"></bdt>LICENSE<bdt
                                                         className="  statement-end-if-in-editor"></bdt></span></span></a> <a
                                data-custom- className="  link" href="#reviews"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#reviews"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">
                                                <bdt  className="  block-component"></bdt>9. GUIDELINES FOR REVIEWS<bdt
                                                         className="  statement-end-if-in-editor"></bdt>
                                        </span></span></a> <a data-custom- className="  link" href="#mobile"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#mobile"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">
                                                <bdt  className="  block-component"></bdt>
                                        </span></span></a> <a data-custom- className="  link" href="#socialmedia"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#socialmedia"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">
                                                <bdt  className="  block-component"></bdt>10. SOCIAL MEDIA<bdt
                                                         className="  statement-end-if-in-editor"></bdt>
                                        </span></span></a> <a data-custom- className="  link" href="#thirdparty"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#thirdparty"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">
                                                <bdt  className="  block-component"></bdt>
                                        </span></span></a> <a data-custom- className="  link" href="#advertisers"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#advertisers"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">
                                                <bdt  className="  block-component"></bdt>
                                        </span></span></a> <a data-custom- className="  link" href="#sitemanage"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#sitemanage"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">11. SERVICES MANAGEMENT</span></span></a>
                        <a data-custom- className="  link" href="#ppyes"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#ppyes"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">
                                                <bdt  className="  block-component"></bdt>12. PRIVACY POLICY<bdt
                                                         className="  statement-end-if-in-editor"></bdt>
                                        </span></span></a> <a data-custom- className="  link" href="#ppno"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#ppno"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">
                                                <bdt  className="  block-component"></bdt>
                                        </span></span></a> <a data-custom- className="  link" href="#dmca"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#dmca"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">
                                                <bdt  className="  block-component"></bdt>
                                                <bdt  className="  block-component"></bdt>
                ...
                <div  className="  MsoNormal" style="line-height: 1.5;"><span style="font-size: 15px;"><span
                                        ...
                                        <bdt  className="  block-component"></bdt>
                                        <bdt  className="  block-component"></bdt>
                                </span></span> <a data-custom- className="  link" href="#terms"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#terms"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">13. TERM AND TERMINATION</span></span></a>
                        <a data-custom- className="  link" href="#modifications"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#modifications"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">14. MODIFICATIONS AND
                                                INTERRUPTIONS</span></span></a> <a data-custom- className="  link"
                                href="#law"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#law"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">15. GOVERNING LAW</span></span></a> <a
                                data-custom- className="  link" href="#disputes"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#disputes"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">16. DISPUTE RESOLUTION</span></span></a>
                        <a data-custom- className="  link" href="#corrections"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#corrections"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">17. CORRECTIONS</span></span></a> <a
                                data-custom- className="  link" href="#disclaimer"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#disclaimer"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">18. DISCLAIMER</span></span></a> <a
                                data-custom- className="  link" href="#liability"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#liability"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">19. LIMITATIONS OF
                                                LIABILITY</span></span></a> <a data-custom- className="  link"
                                href="#indemnification"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link"
                                href="#indemnification"><span style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">20. INDEMNIFICATION</span></span></a> <a
                                data-custom- className="  link" href="#userdata"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#userdata"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">21. USER DATA</span></span></a> <a
                                data-custom- className="  link" href="#electronic"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#electronic"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">22. ELECTRONIC COMMUNICATIONS,
                                                TRANSACTIONS, AND SIGNATURES</span></span></a> <a
                                data-custom- className="  link" href="#california"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#california"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">
                                                <bdt  className="  block-component"></bdt>23. CALIFORNIA USERS AND RESIDENTS
                                                <bdt  className="  statement-end-if-in-editor"></bdt>
                                        </span></span></a> <a data-custom- className="  link" href="#misc"></a></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#misc"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">24. MISCELLANEOUS</span></span></a> <a
                                data-custom- className="  link" href="#contact"></a></div>
                ...
                <div  className="  MsoNormal" style="line-height: 1.5;"><a data-custom- className="  link" href="#contact"><span
                                        style="color: rgb(0, 58, 250); font-size: 15px;"><span
                                                data-custom- className="  body_text">25. CONTACT US</span></span></a></div>
        </div>
        <div align="center" style="text-align: left;">
                ...
                <div  className="  MsoNormal" style="line-height: 1.5;"><br/></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  heading_1" id="services" style="line-height: 1.5;">
                ...
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span
                                ...
                                and to the extent local laws are applicable.<bdt  className="  block-component"></bdt></span>
                        <bdt  className="  block-component"><span style="font-size: 15px;"></span></bdt>
                </div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span
                                ...
                                way that would violate the Gramm-Leach-Bliley Act (GLBA).<bdt  className="  block-component">
                                </bdt>
                                <bdt  className="  statement-end-if-in-editor"></bdt>
                </div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><br/></div>
        </div>
        <div align="center" data-custom- className="  heading_1" style="text-align: left; line-height: 1.5;"><strong><span
                                id="ip" style="font-size: 19px;">2. INTELLECTUAL PROPERTY RIGHTS</span></strong></div>
        <div align="center" style="line-height: 1.5;"><br/></div>
        <div align="center" style="text-align: left;">
                <div  className="  MsoNormal" data-custom- className="  heading_2" style="line-height: 1.5;"><strong>Our intellectual
                                property</strong></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span style="font-size:11.0pt;line-height:115%;font-family:Arial;
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;">We are the owner or the licensee of all intellectual
                                ...
                                (collectively, the <bdt  className="  block-component"></bdt>"Content"<bdt
                                         className="  statement-end-if-in-editor"></bdt>), as well as the trademarks, service
                                marks, and logos contained therein (the <bdt  className="  block-component"></bdt>"Marks"<bdt
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;">The Content and Marks are provided in or through the
                                Services <bdt  className="  block-component"></bdt>"AS IS"<bdt
                                         className="  statement-end-if-in-editor"></bdt> for your <bdt  className="  block-component">
                                </bdt>personal, non-commercial use<bdt  className="  block-component"></bdt> only.</span></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  heading_2" style="line-height: 1.5;"><strong>Your use of our
                                Services</strong></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span
                                style="font-size: 15px;">Subject to your compliance with these Legal Terms, including
                                the <bdt  className="  block-component"></bdt>"<bdt  className="  statement-end-if-in-editor"></bdt>
                                </span><a data-custom- className="  link" href="#prohibited"><span
                                ...
                                section below, we grant you a non-exclusive, non-transferable, revocable <bdt
                                         className="  block-component"></bdt>license<bdt  className="  statement-end-if-in-editor">
                                </bdt> to:
                        </span></div>
                <ul>
                        <li  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span
                ...
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span style="font-size:11.0pt;line-height:115%;font-family:Arial;
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;">solely for your <bdt  className="  block-component"></bdt>
                                personal, non-commercial use<bdt  className="  block-component"></bdt>.</span></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span style="font-size:11.0pt;line-height:115%;font-family:Arial;
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;">If you wish to make any use of the Services, Content,
                                ...
                                address your request to: <bdt  className="  question">support@nexgenstudy.ai</bdt>. If we ever
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;">Any breach of these Intellectual Property Rights will
                ...
                <div  className="  MsoNormal" style="line-height: 1.5;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  heading_2" style="line-height: 1.5;"><span style="font-size:11.0pt;line-height:115%;font-family:Arial;
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"><strong>Your submissions<bdt  className="  block-component">
                ...
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span
                                style="font-size: 15px;">Please review this section and the <bdt
                                         className="  block-component"></bdt>"<bdt  className="  statement-end-if-in-editor"></bdt><a
                                        data-custom- className="  link" href="#prohibited"><span
                ...
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span
                                ...
                                <bdt  className="  block-component"></bdt>"Submissions"<bdt  className="  statement-end-if-in-editor">
                                ...
                                compensation to you.<bdt  className="  block-component"></bdt></span></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span
                                ...
                                reviews, rating suggestions, personal information, or other material (<bdt
                                         className="  block-component"></bdt>"Contributions"<bdt
                                         className="  statement-end-if-in-editor"></bdt>). Any Submission that is publicly
                ...
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span
                                ...
                                users of the Services<bdt  className="  block-component"></bdt>.</span></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span
                                style="font-size: 15px;"><strong>When you post Contributions, you grant us a <bdt
                                                 className="  block-component"></bdt>license<bdt
                                                 className="  statement-end-if-in-editor"></bdt> (including use of your name,
                                ...
                                royalty-free, fully-paid, worldwide right, and <bdt  className="  block-component"></bdt>
                                license<bdt  className="  statement-end-if-in-editor"></bdt> to: use, copy, reproduce,
                                ...
                                </bdt>sublicense the licenses<bdt  className="  statement-end-if-in-editor"></bdt> granted in
                                this section. Our use and distribution may occur in any media formats and through any
                                media channels.</span></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span
                                style="font-size: 15px;">This <bdt  className="  block-component"></bdt>license<bdt
                                         className="  statement-end-if-in-editor"></bdt> includes our use of your name, company
                ...
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span
                                style="font-size: 15px;"><strong>You are responsible for what you post or
                                        upload:</strong> By sending us Submissions<bdt  className="  block-component"></bdt>
                                and/or posting Contributions<bdt  className="  statement-end-if-in-editor"></bdt> through any
                                part of the Services<bdt  className="  block-component"></bdt> or making Contributions
                                accessible through the Services by linking your account through the Services to any of
                                your social networking accounts,<bdt  className="  statement-end-if-in-editor"></bdt>
                                you:</span></div>
                <ul>
                        <li  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span
                                        style="font-size: 15px;">confirm that you have read and agree with our <bdt
                                                 className="  block-component"></bdt>"<bdt  className="  statement-end-if-in-editor">
                                        </bdt></span><a data-custom- className="  link" href="#prohibited"><span
                                                style="color: rgb(0, 58, 250); font-size: 15px;">PROHIBITED
                                                ACTIVITIES</span></a><span style="font-size: 15px;">
                                        <bdt  className="  block-component"></bdt>"<bdt  className="  statement-end-if-in-editor">
                                        </bdt> and will not post, send, publish, upload, or transmit through the
                                        Services any Submission<bdt  className="  block-component"></bdt> nor post any
                                        Contribution<bdt  className="  statement-end-if-in-editor"></bdt> that is illegal,
                        ...
                        <li  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span
                                        ...
                                        and all moral rights to any such Submission<bdt  className="  block-component"></bdt>
                                        and/or Contribution<bdt  className="  statement-end-if-in-editor"></bdt>;</span></li>
                        <li  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span
                                        style="font-size: 15px;">warrant that any such Submission<bdt
                                                 className="  block-component"></bdt> and/or Contributions<bdt
                                                 className="  statement-end-if-in-editor"></bdt> are original to you or that
                                        you have the necessary rights and <bdt  className="  block-component"></bdt>licenses
                                        <bdt  className="  statement-end-if-in-editor"></bdt> to submit such Submissions<bdt
                                                 className="  block-component"></bdt> and/or Contributions<bdt
                                                 className="  statement-end-if-in-editor"></bdt> and that you have full
                                        authority to grant us the above-mentioned rights in relation to your Submissions
                                        <bdt  className="  block-component"></bdt> and/or Contributions<bdt
                                                 className="  statement-end-if-in-editor"></bdt>; and</span></li>
                        <li  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span
                                        style="font-size: 15px;">warrant and represent that your Submissions<bdt
                                                 className="  block-component"></bdt> and/or Contributions<bdt
                                                 className="  statement-end-if-in-editor"></bdt> do not constitute confidential
                                        information.</span></li>
                </ul>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;">You are solely
                        responsible for your Submissions<bdt  className="  block-component"></bdt> and/or Contributions<bdt
                                 className="  statement-end-if-in-editor"></bdt> and you expressly agree to reimburse us for
                        any and all losses that we may suffer because of your breach of (a) this section, (b) any third
                        party’s intellectual property rights, or (c) applicable law.<bdt  className="  block-component"></bdt>
                </div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><strong>We may remove or
                        ...
                        you to the authorities.<bdt  className="  statement-end-if-in-editor"></bdt>
                        <bdt  className="  block-component"></bdt>
                </div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><br/></div>
        </div>
        <div align="center" style="text-align: left;">
                <div  className="  MsoNormal" data-custom- className="  heading_1" id="userreps" style="line-height: 1.5;"><a
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;">By using the Services, you represent and warrant
                        ...
                        <bdt  className="  block-container if" data-type="if" id="8d4c883b-bc2c-f0b4-da3e-6d0ee51aca13">
                                <bdt data-type="conditional-block">
                                        <bdt  className="  block-component" data-record-question-key="user_u13_option"
                                                data-type="statement"></bdt> 
                                </bdt><span style="color: rgb(89, 89, 89); font-size: 11pt;">(</span><span
                                        style="color: rgb(89, 89, 89); font-size: 14.6667px;">4</span><span
                                        style="color: rgb(89, 89, 89); font-size: 11pt;">) you are not a
                                        minor in the jurisdiction in which you reside<bdt  className="  block-container if"
                                        ...
                                        for any illegal or <bdt  className="  block-component"></bdt>unauthorized<bdt
                                                 className="  statement-end-if-in-editor"></bdt> purpose; and (</span><span
        ...
        <div align="center" style="text-align: left;">
                <div  className="  MsoNormal" style="text-align: justify; line-height: 115%;">
                        <div  className="  MsoNormal" style="line-height: 17.25px;">
                                <div  className="  MsoNormal" data-custom- className="  body_text"
                                        style="line-height: 1.5; text-align: left;"><span
                                                ...
                                                thereof).</span></div>
                                <div  className="  MsoNormal" style="line-height: 1.1; text-align: left;">
                                        <bdt  className="  block-component"></bdt>
                                </div>
                        ...
                        <div  className="  MsoNormal" style="line-height: 1;">
                                <bdt data-type="conditional-block">
                                        <bdt data-type="body">
                                                <div  className="  MsoNormal" data-custom- className="  heading_1" id="userreg"
                        ...
                        <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;">
                                <bdt  className="  block-component"><span style="font-size: 15px;"></bdt></span>
                        </div>
                        <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;">
                                <bdt  className="  block-component"><span style="font-size: 15px;"></span></bdt>
                        </div>
        ...
        <div align="center" style="text-align: left;">
                <div  className="  MsoNormal" data-custom- className="  heading_1" id="purchases" style="line-height: 1.5;"><a
        ...
        <div align="center" style="text-align: left;">
                ...
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span
                                style="font-size: 15px;">All purchases are non-refundable.</span></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><span style="font-size: 15px;"><br/></span></div>
                <div  className="  MsoNormal" style="line-height: 1.5;">
                        <bdt  className="  statement-end-if-in-editor"><span style="font-size: 15px;"></span></bdt>
                </div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span style="font-size:11.0pt;line-height:115%;font-family:Arial;
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;">We accept the following forms of payment:</span></div>
                <div  className="  MsoNormal" style="text-align:justify;line-height:115%;">
                        <div  className="  MsoNormal" style="text-align: left; line-height: 1;"><br/></div>
                </div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5; margin-left: 20px;"><span
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;">You agree to provide current, complete, and accurate
                                ...
                                <bdt  className="  question"></bdt>.</span></div>
        </div>
        <div align="center" style="line-height: 1.5;"><br/></div>
        <div align="center" style="text-align: left;">
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span style="font-size:11.0pt;line-height:115%;font-family:Arial;
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;">You agree to pay all charges at the prices then in
                                effect for your purchases and any applicable shipping fees, and you <bdt
                                         className="  block-component"></bdt>authorize<bdt  className="  statement-end-if-in-editor">
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;">We reserve the right to refuse any order placed
                                ...
                                orders that, in our sole <bdt  className="  block-component"></bdt>judgment<bdt
                                         className="  statement-end-if-in-editor"></bdt>, appear to be placed by dealers,
                                ...
                                <bdt data-type="conditional-block" style="color: rgb(10, 54, 90); text-align: left;">
                                        <bdt  className="  block-component" data-record-question-key="return_option"
                ...
                <div  className="  MsoNormal" style="text-align: justify; line-height: 1.5;"><span
                                style="line-height: 115%; font-family: Arial; color: rgb(89, 89, 89);">
                                <bdt data-type="conditional-block" style="color: rgb(10, 54, 90); text-align: left;">
                                        <bdt data-type="body">
                                                <div  className="  MsoNormal" style="font-size: 15px; line-height: 1.5;"><br/>
                                                </div>
                                        </bdt>
                                </bdt>
                        </span>
                        <div  className="  MsoNormal" data-custom- className="  heading_1" id="prohibited"
                                style="text-align: left; line-height: 1.5;"><strong><span
                                                style="line-height: 24.5333px; font-size: 19px;"><strong><span
                                                                style="line-height: 115%; font-family: Arial; font-size: 19px;"><strong><span
                                                                                style="line-height: 115%; font-family: Arial; font-size: 19px;"><strong><span
                                                                                                style="line-height: 115%; font-family: Arial; font-size: 19px;">6.</span></strong></span> </strong></span></strong>PROHIBITED
                ...
                <div  className="  MsoNormal" style="text-align: justify; line-height: 1;">
                        <div  className="  MsoNormal" data-custom- className="  body_text"
                                style="line-height: 1.5; text-align: left;"><span
                                        ...
                                        commercial <bdt  className="  block-component"></bdt>endeavors<bdt
                                                 className="  statement-end-if-in-editor"></bdt> except those that are
                                        specifically endorsed or approved by us.</span></div>
                </div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><br/></div>
                <div  className="  MsoNormal" style="text-align: justify; line-height: 1;">
                        <div  className="  MsoNormal" style="line-height: 17.25px;">
                                <div  className="  MsoNormal" style="line-height: 1.1;">
                                        <div  className="  MsoNormal" style="line-height: 17.25px;">
                                                <div  className="  MsoNormal" data-custom- className="  body_text"
                                                        style="line-height: 1.5; text-align: left;"><span
                                        ...
                                        <ul>
                                                ...
                                                <li  className="  MsoNormal" data-custom- className="  body_text"
                                                        style="line-height: 1.5; text-align: left;"><span
                                                                ...
                                                                <bdt  className="  question">Use the Services to advertise or
                        ...
                        <div  className="  MsoNormal" style="line-height: 17.25px;">
                                <div  className="  MsoNormal" style="line-height: 1;">
                                        <bdt  className="  block-container if" data-type="if" style="text-align: left;">
                                                <bdt data-type="conditional-block">
                                                        <bdt data-type="body">
                                                                <div  className="  MsoNormal" data-custom- className="  heading_1"
                                                                        id="ugc" style="line-height: 1.5;"><strong><span
                                                                                        style="line-height: 24.5333px; font-size: 19px;"><strong><span
                                                                                                        style="line-height: 24.5333px; font-size: 19px;"><strong><span
                                                                                                                        style="line-height: 115%; font-family: Arial; font-size: 19px;"><strong><span
                                                                                                                                        style="line-height: 115%; font-family: Arial; font-size: 19px;">7.</span></strong></span></strong></span> </strong>USER
                                                                                        GENERATED
                                                        ...
                                                        <bdt data-type="body">
                                                                <div  className="  MsoNormal" data-custom- className="  body_text"
                                                                        style="line-height: 1.5;"><span
                                                                                style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);">
                                                                                <bdt  className="  block-container if"
                                                                                        data-type="if"
                                                                                ...
                                                                                </bdt>The Services may invite you to
                                                                                ...
                                                                                "Contributions"<bdt
                                                                                         className="  statement-end-if-in-editor">
                                                                                </bdt>). Contributions may be viewable
                                ...
                                <ul style="font-size: medium;text-align: left;">
                                        <li data-custom- className="  body_text" style="line-height: 1.5;"><span
                                                        style="color: rgb(89, 89, 89);"><span
                                                                style="font-size: 14px;"><span
                                                                        data-custom- className="  body_text">The creation,
                                        ...
                                        <li data-custom- className="  body_text" style="line-height: 1.5;"><span
                                                        style="color: rgb(89, 89, 89);"><span
                                                                style="font-size: 14px;"><span
                                                                        data-custom- className="  body_text">You are the
                                                                        creator and owner of or have the necessary <bdt
                                                                                 className="  block-component"></bdt>licenses
                                                                        <bdt  className="  statement-end-if-in-editor"></bdt>,
                                                                        rights, consents, releases, and permissions to
                                                                        use and to <bdt  className="  block-component"></bdt>
                                                                        authorize<bdt
                                                                                 className="  statement-end-if-in-editor">
                                                                        </bdt> us, the Services, and other users of the
                                        ...
                                        <li data-custom- className="  body_text" style="line-height: 1.5;"><span
                                                        style="color: rgb(89, 89, 89);"><span
                                                                style="font-size: 14px;"><span
                                                                        data-custom- className="  body_text">You have the
                                        ...
                                        <li data-custom- className="  body_text" style="line-height: 1.5;"><span
                                                        style="color: rgb(89, 89, 89);"><span
                                                                style="font-size: 14px;"><span
                                                                        data-custom- className="  body_text">Your Contributions
                                        ...
                                        <li data-custom- className="  body_text" style="line-height: 1.5;"><span
                                                        style="color: rgb(89, 89, 89);"><span
                                                                style="font-size: 14px;"><span
                                                                        ...
                                                                        violent, harassing, <bdt
                                                                                 className="  block-component"></bdt>libelous
                                                                        <bdt  className="  statement-end-if-in-editor"></bdt>,
                                                                        slanderous, or otherwise objectionable (as
                                                                        determined by us).</span></span></span></li>
                                        <li data-custom- className="  body_text" style="line-height: 1.5;"><span
                                                        style="color: rgb(89, 89, 89);"><span
                                                                style="font-size: 14px;"><span
                                                                        data-custom- className="  body_text">Your Contributions
                ...
                <div  className="  MsoNormal" style="text-align: justify; line-height: 1;">
                        <bdt  className="  block-container if" data-type="if" style="text-align: left;">
                                <bdt data-type="conditional-block">
                                        <bdt data-type="body">
                                                <div  className="  MsoNormal" data-custom- className="  heading_1" id="license"
                                                        style="line-height: 1.5;"><strong><span
                                                                        style="line-height: 24.5333px; font-size: 19px;"><strong><span
                                                                                        style="line-height: 24.5333px; font-size: 19px;"><strong><span
                                                                                                        style="line-height: 115%; font-family: Arial; font-size: 19px;"><strong><span
                                                                                                                        style="line-height: 115%; font-family: Arial; font-size: 19px;">8.</span></strong></span></strong></span> </strong>CONTRIBUTION
                                                                        <bdt  className="  block-component"></bdt>LICENSE<bdt
                                                                                 className="  statement-end-if-in-editor">
                                                                        </bdt></span></strong></div>
                                        </bdt>
                                </bdt>
                                                        ...
                                                        style="line-height: 1.5;"><span
                                                                ...
                                                                <bdt  className="  block-container if" data-type="if"
                                                                        ...
                                                                        <bdt  className="  statement-end-if-in-editor"
                                                                                data-type="close"></bdt>
                                                                </bdt>, you automatically grant, and you represent and
                                                                ...
                                                                worldwide right, and <bdt  className="  block-component"></bdt>
                                                                ...
                                                                Contributions, and grant and <bdt
                                                                         className="  block-component"></bdt>authorize
                                                                sublicenses<bdt  className="  statement-end-if-in-editor">
                                                                </bdt> of the foregoing. The use and distribution may
                                        ...
                                        <bdt data-type="body">
                                                <div  className="  MsoNormal" data-custom- className="  body_text"
                                                        style="line-height: 1.5;"><span
                                                                ...
                                                                <bdt  className="  block-component"></bdt>license<bdt
                                                                         className="  statement-end-if-in-editor"></bdt> will
                                                                ...
                                                                asserted in your Contributions.</span></div>
                                        </bdt>
                                </bdt>
                        </bdt>
                </div>
                                        ...
                                        <bdt data-type="body">
                                                <div  className="  MsoNormal" data-custom- className="  body_text"
                                                        style="line-height: 1.5;"><span
                                                                ...
                                                                (2) to <bdt  className="  block-component"></bdt>re-categorize
        ...
        <div align="center" style="text-align: left;">
                ...
                <div  className="  MsoNormal" data-custom- className="  heading_1" id="reviews" style="line-height: 1.5;">
                        <strong><span style="line-height: 24.5333px; font-size: 19px;"><strong><span
                                                        style="line-height: 115%; font-family: Arial; font-size: 19px;"><strong><span
                                                                        style="line-height: 115%; font-family: Arial; font-size: 19px;">9.</span></strong></span> </strong></span>GUIDELINES
                                FOR REVIEWS</strong></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span
                                style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);">We may provide
                                ...
                                <bdt  className="  block-component"></bdt>organize<bdt  className="  statement-end-if-in-editor">
                ...
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span
                                style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);"><span
                                        ...
                                        paid, assignable, and sublicensable right and <bdt  className="  block-component">
                                        </bdt>license<bdt  className="  statement-end-if-in-editor"></bdt> to reproduce,
                ...
                <div  className="  MsoNormal" data-custom- className="  heading_1" id="socialmedia" style="line-height: 1.5;">
                        <strong><span style="line-height: 24.5333px; font-size: 19px;"><strong><span
                                                        style="line-height: 115%; font-family: Arial; font-size: 19px;"><strong><span
                                                                        style="line-height: 115%; font-family: Arial; font-size: 19px;">10.</span></strong></span> </strong></span>SOCIAL
                                MEDIA</strong></div>
                <div  className="  MsoNormal" style="line-height: 1.5;"><br/>
                        <bdt  className="  block-container if" data-type="if" style="text-align: left;">
                                <bdt data-type="conditional-block">
                                        <bdt data-type="body">
                                                <div  className="  MsoNormal" data-custom- className="  body_text"
                                                        style="line-height: 1.5;"><span
                                                                ...
                                                                third-party service providers (each such account, a <bdt
                                                                         className="  block-component"></bdt>"Third-Party
                                                                Account"<bdt  className="  statement-end-if-in-editor"></bdt>)
                                                                ...
                                                                the third-party service provider of the <span
                                                                        style="font-size: 14.6667px;">Third-Party</span>
                                                                ...
                                                                you have provided to and stored in your <span
                                                                        style="font-size: 14.6667px;">Third-Party</span>
                                                                Account (the <bdt  className="  block-component"></bdt>"Social
                                                                Network Content"<bdt  className="  statement-end-if-in-editor">
                                                                </bdt>) so that it is available on and through the
                                                                ...
                                                                the connection between the Services and your <span
                                                                        style="font-size: 14.6667px;">Third-Party</span>
                                                                ...
                                                                servers that was obtained through such <span
                                                                        style="font-size: 14.6667px;">Third-Party</span>
                ...
                <div  className="  MsoNormal" style="line-height: 1.5;">
                        <bdt  className="  block-container if" data-type="if" style="text-align: left;">
                                <bdt data-type="conditional-block">
                                        <bdt  className="  block-component" data-record-question-key="3rd_party_option"
                                                data-type="statement"></bdt>
                                </bdt>
                </div>
                <div  className="  MsoNormal" style="line-height: 1.5;">
                ...
                <div  className="  MsoNormal" data-custom- className="  heading_1" id="sitemanage" style="line-height: 1.5;">
                        <strong><span style="line-height: 24.5333px; font-size: 19px;"><strong><span
                                                        style="line-height: 24.5333px; font-size: 19px;"><strong><span
                                                                        style="line-height: 115%; font-family: Arial; font-size: 19px;"><strong><span
                ...
                <div  className="  MsoNormal" style="line-height: 1.5;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;">We reserve the right, but
                ...
                <div  className="  MsoNormal" data-custom- className="  heading_1" id="ppyes" style="line-height: 1.5;"><strong><span
                                        style="line-height: 24.5333px; font-size: 19px;"><strong><span
                                                        style="line-height: 115%; font-family: Arial; font-size: 19px;"><strong><span
                ...
                <div  className="  MsoNormal" style="line-height: 1.5;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5;"><span
                                style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);">We care about
                                data privacy and security. Please review our Privacy Policy:<strong> <span
                                                ...
                                                <bdt  className="  block-container question question-in-editor"
                                                        ...
                                                        data-type="question"><a
                                                                href="https://nexgenstudy.ai/privacy_polocy"
                                                                target="_blank"
                                                                data-custom- className="  link">https://nexgenstudy.ai/privacy_polocy</a>
                                                </bdt>
                                        </span></strong>. By using the Services, you agree to be bound by our Privacy
                                Policy, which is incorporated into these Legal Terms. Please be advised the Services are
                                hosted in <bdt  className="  block-component"></bdt>the <bdt  className="  question">United States
                                </bdt>
                                <bdt  className="  block-component"></bdt>
                                <bdt  className="  block-component"></bdt>
                                <bdt  className="  forloop-component"></bdt>
                                <bdt  className="  block-component"></bdt>
                                <bdt  className="  block-component"></bdt>, <bdt  className="  question">India</bdt>
                                <bdt  className="  statement-end-if-in-editor"></bdt>
                                <bdt  className="  statement-end-if-in-editor"></bdt>
                                <bdt  className="  forloop-component"></bdt>
                                <bdt  className="  block-component"></bdt>
                                <bdt  className="  block-component"></bdt>, <bdt  className="  question">South Korea</bdt>
                                <bdt  className="  statement-end-if-in-editor"></bdt>
                                <bdt  className="  statement-end-if-in-editor"></bdt>
                                <bdt  className="  forloop-component"></bdt>
                                <bdt  className="  block-component"></bdt>
                                <bdt  className="  block-component"></bdt> and <bdt  className="  question">Japan</bdt>
                                <bdt  className="  statement-end-if-in-editor"></bdt>
                                <bdt  className="  else-block"></bdt>
                                <bdt  className="  forloop-component"></bdt>
                                <bdt  className="  statement-end-if-in-editor"></bdt>. If you access the Services from any
                                ...
                                <bdt  className="  else-block"></bdt>
                                <bdt  className="  forloop-component"></bdt>
                                <bdt  className="  statement-end-if-in-editor"></bdt>, then through your continued use of the
                                ...
                                <bdt  className="  else-block"></bdt>
                                <bdt  className="  forloop-component"></bdt>
                                <bdt  className="  statement-end-if-in-editor"></bdt>, and you expressly consent to have your
                                data transferred to and processed in <span
                                        style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);">
                                        <bdt  className="  block-component"></bdt>the <bdt  className="  question">United States</bdt>
                                        <bdt  className="  block-component"></bdt>
                                </span>
                                ...
                                <bdt  className="  statement-end-if-in-editor"></bdt>
                                <bdt  className="  forloop-component"></bdt>
                                <bdt  className="  statement-end-if-in-editor"></bdt>.<bdt  className="  block-component"></bdt>
                                <bdt  className="  block-container if" data-type="if"
                ...
                <div  className="  MsoNormal" style="line-height: 1.5;">
                        ...
                        <bdt  className="  block-container if" data-type="if">
                                <bdt data-type="conditional-block">
                                        <bdt  className="  block-component" data-record-question-key="privacy_policy_followup"
                ...
                <div  className="  MsoNormal" data-custom- className="  heading_1" id="terms"
                        style="line-height: 1.5; text-align: left;"><strong><span
                                        style="line-height: 24.5333px; font-size: 19px;"><strong><span
                                                        style="line-height: 24.5333px; font-size: 19px;"><strong><span
                                                                        style="line-height: 115%; font-family: Arial; font-size: 19px;"><strong><span
                ...
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5; text-align: left;"><span
                                style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);">These Legal
                                ...
                                TERMINATE YOUR USE OR PARTICIPATION IN THE SERVICES OR DELETE <bdt
                                        ...
                                        <bdt  className="  statement-end-if-in-editor" data-type="close"></bdt>
                                </bdt>ANY CONTENT OR INFORMATION THAT YOU POSTED AT ANY TIME, WITHOUT WARNING, IN OUR
                                SOLE DISCRETION.</span></div>
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5; text-align: left;"><span
                                style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);">If we terminate
                                ...
                                including without limitation pursuing civil, criminal, and injunctive redress.</span>
                </div>
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  heading_1" id="modifications"
                        style="line-height: 1.5; text-align: left;"><strong><span
                                        style="line-height: 24.5333px; font-size: 19px;"><strong><span
                                                        style="line-height: 24.5333px; font-size: 19px;"><strong><span
                                                                        style="line-height: 115%; font-family: Arial; font-size: 19px;"><strong><span
                ...
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5; text-align: left;"><span
                                style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);">We reserve the
                                ...
                                any information on our Services.<bdt  className="  block-component"></bdt> We will not be
                                liable to you or any third party for any modification, price change, suspension, or
                                discontinuance of the Services.</span></div>
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5; text-align: left;"><span
                ...
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  heading_1" id="law"
                        style="line-height: 1.5; text-align: left;"><strong><span
                                        style="line-height: 24.5333px; font-size: 19px;"><strong><span
                                                        style="line-height: 24.5333px; font-size: 19px;"><strong><span
                                                                        style="line-height: 115%; font-family: Arial; font-size: 19px;"><strong><span
                                        ...
                                        LAW</span></strong></div>
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;"><br/></div>
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;"><span
                                style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);">
                                <bdt  className="  block-component"></bdt>
                        </span></div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5; text-align: left;"><span
                                ...
                                laws of <bdt  className="  block-container if" data-type="if"
                                        id="b86653c1-52f0-c88c-a218-e300b912dd6b">
                                        <bdt data-type="conditional-block">
                                                <bdt  className="  block-component" data-record-question-key="governing_law"
                                                        data-type="statement"></bdt>
                                                <bdt data-type="body">the State of <bdt
                                                                 className="  block-container question question-in-editor"
                                                                data-id="b61250bd-6b61-32ea-a9e7-4a02690297c3"
                                                                data-type="question">Texas</bdt>
                                                </bdt>
                                        </bdt>
                                        <bdt  className="  statement-end-if-in-editor" data-type="close"></bdt>
                                </bdt> applicable to agreements made and to be entirely performed within<bdt
                                         className="  block-container if" data-type="if"
                                        id="b86653c1-52f0-c88c-a218-e300b912dd6b" style="font-size: 14.6667px;">
                                        <bdt data-type="conditional-block"> <span
                                                        ...
                                                        <bdt  className="  block-container if" data-type="if"
                                                                ...
                                                                <bdt  className="  statement-end-if-in-editor"
                                                                        data-type="close"></bdt>
                                                        </bdt><span style="font-size: 14.6667px;">, </span>without
                                                        regard to its conflict of law principles.<bdt
                                                                 className="  block-component"></bdt>
                                                </span></div>
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  heading_1" id="disputes"
                        style="line-height: 1.5; text-align: left;"><strong><span
                                        style="line-height: 24.5333px; font-size: 19px;"><strong><span
                                                        style="line-height: 24.5333px; font-size: 19px;"><strong><span
                                                                        style="line-height: 115%; font-family: Arial; font-size: 19px;"><strong><span
                ...
                <div  className="  MsoNormal" data-custom- className="  heading_2" style="line-height: 1.5; text-align: left;">
                        <strong>Informal Negotiations</strong></div>
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5; text-align: left;"><span
                                style="font-size: 15px;">To expedite resolution and control the cost of any dispute,
                                controversy, or claim related to these Legal Terms (each a <bdt  className="  block-component">
                                </bdt>"Dispute" and collectively, the "Disputes"<bdt  className="  statement-end-if-in-editor">
                                </bdt>) brought by either you or us (individually, a <bdt  className="  block-component"></bdt>
                                "Party" and collectively, the "Parties"<bdt  className="  statement-end-if-in-editor"></bdt>),
                                the Parties agree to first attempt to negotiate any Dispute (except those Disputes
                                expressly provided below) informally for at least <bdt  className="  question"></bdt> days
                ...
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5; text-align: left;">
                        <bdt  className="  block-component"><span style="font-size: 15px;"></bdt>
                </div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5; text-align: left;">Any
                        ...
                        <bdt  className="  question"></bdt>. The seat, or legal place, or arbitration shall be <bdt
                                 className="  block-component"></bdt>
                        <bdt  className="  block-component"></bdt>
                        <bdt  className="  block-component"></bdt>
                        ...
                        <bdt  className="  statement-end-if-in-editor">
                                <bdt  className="  statement-end-if-in-editor"></bdt>
                                <bdt  className="  statement-end-if-in-editor"></bdt>
                        </bdt>. The language of the proceedings shall be <bdt  className="  question"></bdt>. The governing law
                        of these Legal Terms shall be substantive law of <bdt  className="  block-component"></bdt>
                        <bdt  className="  block-component"></bdt>
                        <bdt  className="  question"></bdt>
                        <bdt  className="  statement-end-if-in-editor">
                                <bdt  className="  statement-end-if-in-editor"></bdt>
                        </bdt>.<bdt  className="  statement-end-if-in-editor">
                                <bdt  className="  statement-end-if-in-editor"></bdt>
                        </bdt>
                </div>
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;"><br/></div>
                ...
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5; text-align: left;">The
                        ...
                        class-action basis or to <bdt  className="  block-component"></bdt>utilize<bdt
                                 className="  statement-end-if-in-editor"></bdt> class action procedures; and (c) there is no
                ...
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  heading_2" style="line-height: 1.5; text-align: left;">
                        <bdt  className="  block-component"></bdt><strong>Exceptions to Informal Negotiations and
                                Arbitration</strong>
                        <bdt  className="  statement-end-if-in-editor"></bdt>
                </div>
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5; text-align: left;">
                        <bdt  className="  block-component"></bdt>The Parties agree that the following Disputes are not subject
                        ...
                        invasion of privacy, or <bdt  className="  block-component"></bdt>unauthorized<bdt
                                 className="  statement-end-if-in-editor"></bdt> use; and (c) any claim for injunctive relief.
                        ...
                        jurisdiction of that court.<bdt  className="  statement-end-if-in-editor"></bdt>
                </div>
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;">
                        <bdt  className="  statement-end-if-in-editor">
                                <bdt  className="  statement-end-if-in-editor"></bdt>
                ...
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  heading_1" id="corrections"
                ...
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5; text-align: left;">There
                ...
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  heading_1" id="disclaimer"
                        style="line-height: 1.5; text-align: left;"><span
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;">THE SERVICES ARE PROVIDED ON AN AS-IS AND AS-AVAILABLE
                                ...
                                NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE OF THE SERVICES, (3) ANY <bdt
                                         className="  block-component"></bdt>UNAUTHORIZED<bdt
                                         className="  statement-end-if-in-editor"></bdt> ACCESS TO OR USE OF OUR SECURE SERVERS
                                ...
                                SERVICE THROUGH ANY MEDIUM OR IN ANY ENVIRONMENT, YOU SHOULD USE YOUR BEST <bdt
                                         className="  block-component"></bdt>JUDGMENT<bdt  className="  statement-end-if-in-editor">
                                </bdt> AND EXERCISE CAUTION WHERE APPROPRIATE.</span></div>
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  heading_1" id="liability"
                        style="line-height: 1.5; text-align: left;"><strong><span
                                        style="line-height: 115%; font-family: Arial; font-size: 19px;"><strong><span
                                                        style="line-height: 24.5333px; font-size: 19px;"><strong><span
                                                                        style="line-height: 115%; font-family: Arial; font-size: 19px;"><strong><span
                ...
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;"><br/></div>
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;"><span style="font-size:11.0pt;line-height:115%;font-family:Arial;
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"><span data-custom- className="  body_text">IN NO EVENT WILL
                                ...
                                <bdt  className="  block-container if" data-type="if"
                                        id="3c3071ce-c603-4812-b8ca-ac40b91b9943"><span data-custom- className="  body_text">
                                                <bdt data-type="conditional-block">
                                                        <bdt  className="  block-component"
                                                        ...
                                                        <bdt data-type="body">NOTWITHSTANDING ANYTHING TO THE CONTRARY
                                                                ...
                                                                WILL AT ALL TIMES BE LIMITED TO <bdt
                                                                         className="  block-container if" data-type="if"
                                                                        ...
                                                                        <bdt data-type="conditional-block">
                                                                                <bdt  className="  block-component"
                                                                                        data-record-question-key="limitations_liability_option"
                                                                                        data-type="statement"></bdt>
                                                                                <bdt data-type="body">THE LESSER OF THE
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;">
                                                                                <bdt  className="  block-container if"
                                                                                        ...
                                                                                        <bdt  className="  statement-end-if-in-editor"
                                                                                                data-type="close"><span
                                                                                                        data-custom- className="  body_text">.</span>
                                                                                        </bdt>
                                                                                </bdt> 
                                                                        </span><span
                                                                                data-custom- className="  body_text">CERTAIN US
                                        ...
                                        <bdt  className="  statement-end-if-in-editor" data-type="close"><span
                                                        data-custom- className="  body_text"></span></bdt>
                                </bdt>
                        </span></div>
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  heading_1" id="indemnification"
                        style="line-height: 1.5; text-align: left;"><strong><span
                                        style="line-height: 115%; font-family: Arial; font-size: 19px;"><strong><span
                                                        style="line-height: 24.5333px; font-size: 19px;"><strong><span
                                                                        style="line-height: 115%; font-family: Arial; font-size: 19px;"><strong><span
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;">You agree to
                                ...
                                party, including but not limited to intellectual property rights; or (<span
                                        style="font-size: 14.6667px;">6</span>) any overt harmful act toward any other
                                ...
                                foregoing, we reserve the right, at your expense, to assume the exclusive <bdt
                                         className="  block-component"></bdt>defense<bdt  className="  statement-end-if-in-editor">
                                </bdt> and control of any matter for which you are required to indemnify us, and you
                                agree to cooperate, at your expense, with our <bdt  className="  block-component"></bdt>defense
                                <bdt  className="  statement-end-if-in-editor"></bdt> of such claims. We will use reasonable
                ...
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  heading_1" id="userdata"
                        style="line-height: 1.5; text-align: left;"><strong><span
                                        style="line-height: 115%; font-family: Arial; font-size: 19px;"><strong><span
                                                        style="line-height: 24.5333px; font-size: 19px;"><strong><span
                                                                        style="line-height: 115%; font-family: Arial; font-size: 19px;"><strong><span
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;">We will maintain
                ...
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  heading_1" id="electronic"
                        style="line-height: 1.5; text-align: left;"><strong><span
                                        style="line-height: 115%; font-family: Arial; font-size: 19px;"><strong><span
                                                        style="line-height: 24.5333px; font-size: 19px;"><strong><span
                                                                        style="line-height: 115%; font-family: Arial; font-size: 19px;"><strong><span
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;">Visiting the Services, sending us emails, and
                ...
                <div  className="  MsoNormal" data-custom- className="  heading_1" id="california"
                        style="line-height: 1.5; text-align: left;"><strong><span
                                        style="line-height: 115%; font-family: Arial; font-size: 19px;"><strong><span
                                                        style="line-height: 24.5333px; font-size: 19px;"><strong><span
                                                                        style="line-height: 115%; font-family: Arial; font-size: 19px;"><strong><span
                                                                                        style="line-height: 115%; font-family: Arial; font-size: 19px;">23.</span></strong></span></strong></span> </strong>CALIFORNIA
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;">If any complaint
                ...
                <div  className="  MsoNormal" data-custom- className="  heading_1" id="misc"
                        style="line-height: 1.5; text-align: left;"><strong><span
                                        style="line-height: 115%; font-family: Arial; font-size: 19px;"><strong><span
                                                        style="line-height: 24.5333px; font-size: 19px;"><strong><span
                                                                        style="line-height: 115%; font-family: Arial; font-size: 19px;"><strong><span
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;">These Legal Terms and any policies or operating rules
                                ...
                                construed against us by virtue of having drafted them. You hereby waive any and all <bdt
                                         className="  block-component"></bdt>defenses<bdt  className="  statement-end-if-in-editor">
                                </bdt> you may have based on the electronic form of these Legal Terms and the lack of
                                signing by the parties hereto to execute these Legal Terms.</span></div>
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;">
                        <bdt  className="  block-component"><span style="font-size: 15px;"></bdt></span>
                </div>
                <div  className="  MsoNormal" style="line-height: 1.5; text-align: left;"><br/></div>
                <div  className="  MsoNormal" data-custom- className="  heading_1" id="contact"
                        style="line-height: 1.5; text-align: left;"><strong><span
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;">In order to resolve a complaint regarding the Services
                ...
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5; text-align: left;"><span
                                style="font-size: 15px;"><span style="color: rgb(89, 89, 89);">
                                        <bdt  className="  question"><strong>dasTEK Solutions, LLC</strong></bdt><strong>
                                                <bdt  className="  block-component"></bdt>
                                </span>
                                <bdt  className="  block-component"></bdt>
                ...
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5; text-align: left;"><span
                                ...
                                <bdt  className="  question"><strong>United States</strong></bdt><strong>
                                        <bdt  className="  statement-end-if-in-editor"><span
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"><strong>
                ...
                <div  className="  MsoNormal" data-custom- className="  body_text" style="line-height: 1.5; text-align: left;">
                        <strong><span style="font-size:11.0pt;line-height:115%;font-family:Arial;
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"><strong>
                                                <bdt  className="  question">support@nexgenstudy.ai</bdt>
                                        </strong></span></strong></div>
        </div>
</div>    
    </>
